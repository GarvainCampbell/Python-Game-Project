...
board = pygame.image.load("Images/Snakes-and-Ladders-Bigger.jpg")
...
redgoti = pygame.image.load("Images/redgoti.png")
yellowgoti = pygame.image.load("Images/yellowgoti.png")
greengoti = pygame.image.load("Images/greengoti.png")
bluegoti = pygame.image.load("Images/bluegoti.png")
menubg = pygame.image.load("Images/menu.jpg")
p = pygame.image.load("Images/playbg.jpg")
intbg = pygame.image.load("Images/intropic.png")
intbg2 = pygame.image.load("Images/intropic2.jpg")
intbg3 = pygame.image.load("Images/intropic3.jpg")
intbg4 = pygame.image.load("Images/intropic4.jpg")
intbg5 = pygame.image.load("Images/intropic5.jpg")

pygame.mixer.music.load("Sound/music.wav")
snakesound = pygame.mixer.Sound("Sound/snake.wav")
