...
class Alien2(Sprite):
    ...
    def __init__(self, space_impact, settings):
        ...
        self.timer = 0
        self.image = []
        self.image.append(pygame.image.load('images/alien_2_1.png'))
    ...
    def update(self):
        ...
        self.x -= self.settings.alien_speed * 0.75
        self.rect.x = self.x
        ...
        if self.index == 0:
            self.image = pygame.image.load("images/alien_2_1.png")
        if self.index == 1:
            self.image = pygame.image.load("images/alien_2_2.png")
